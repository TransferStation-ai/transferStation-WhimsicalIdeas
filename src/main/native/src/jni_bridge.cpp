...
// Serialization helper for native parser JNI methods
struct ByteWriter {
...
Java_transferstation_transferstation_1whimsicalideas_client_model_GmodNativeBridge_nativeParseMdlSerialized(
    JNIEnv* env, jclass, jbyteArray mdlData)
{
    ...
    try {
        ...
        ByteWriter w;
        const int MAGIC = 0x574E5054; // PARSE_MAGIC + 1
        w.writeInt(MAGIC);
...
JNIEXPORT jbyteArray JNICALL
Java_transferstation_transferstation_1whimsicalideas_client_model_GmodNativeBridge_nativeParseVvdSerialized(
    JNIEnv* env, jclass, jbyteArray vvdData)
{
    ...
    try {
        ...
        ByteWriter w;
        const int MAGIC = 0x574E5055; // PARSE_MAGIC + 2
        w.writeInt(MAGIC);
        w.writeInt(parsed.header.id);
        w.writeInt(parsed.header.version);
        w.writeInt(parsed.header.checksum);
...
JNIEXPORT jbyteArray JNICALL
Java_transferstation_transferstation_1whimsicalideas_client_model_GmodNativeBridge_nativeParseVtxSerialized(
    JNIEnv* env, jclass, jbyteArray vtxData)
{
    ...
    try {
        ...
        ByteWriter w;
        const int MAGIC = 0x574E5056; // PARSE_MAGIC + 3
        w.writeInt(MAGIC);
        ...
        // Collect triangle lists from base LOD meshStripGroups
...
JNIEXPORT jbyteArray JNICALL
Java_transferstation_transferstation_1whimsicalideas_client_model_GmodNativeBridge_nativeParsePhySerialized(
