...
public class GmodModelRenderer {
    ...
    private static final int COLOR_SKIN = 0xFFD4A574;
    private static final int COLOR_SHIRT = 0xFF4A90D9;
    private static final int COLOR_PANTS = 0xFF4A4A4A;
    private static final int COLOR_SHOES = 0xFF2A2A2A;
    private static final int COLOR_EYE_WHITE = 0xFFFFFFFF;
    private static final int COLOR_PUPIL = 0xFF222222;
    private static final int COLOR_MOUTH = 0xFF8B5E5E;
    private static final int COLOR_EYEBROW = 0xFF5C3D2E;

    private static final float COLOR_R_SKIN = ((COLOR_SKIN >> 16) & 0xFF) / 255f;
    private static final float COLOR_G_SKIN = ((COLOR_SKIN >> 8) & 0xFF) / 255f;
    private static final float COLOR_B_SKIN = (COLOR_SKIN & 0xFF) / 255f;
    private static final float COLOR_R_SHIRT = ((COLOR_SHIRT >> 16) & 0xFF) / 255f;
    private static final float COLOR_G_SHIRT = ((COLOR_SHIRT >> 8) & 0xFF) / 255f;
    private static final float COLOR_B_SHIRT = (COLOR_SHIRT & 0xFF) / 255f;
    private static final float COLOR_R_PANTS = ((COLOR_PANTS >> 16) & 0xFF) / 255f;
    private static final float COLOR_G_PANTS = ((COLOR_PANTS >> 8) & 0xFF) / 255f;
    private static final float COLOR_B_PANTS = (COLOR_PANTS & 0xFF) / 255f;
    private static final float COLOR_R_SHOES = ((COLOR_SHOES >> 16) & 0xFF) / 255f;
    private static final float COLOR_G_SHOES = ((COLOR_SHOES >> 8) & 0xFF) / 255f;
    private static final float COLOR_B_SHOES = (COLOR_SHOES & 0xFF) / 255f;
    private static final float COLOR_R_EYE_WHITE = ((COLOR_EYE_WHITE >> 16) & 0xFF) / 255f;
    private static final float COLOR_G_EYE_WHITE = ((COLOR_EYE_WHITE >> 8) & 0xFF) / 255f;
    private static final float COLOR_B_EYE_WHITE = (COLOR_EYE_WHITE & 0xFF) / 255f;
    private static final float COLOR_R_PUPIL = ((COLOR_PUPIL >> 16) & 0xFF) / 255f;
    private static final float COLOR_G_PUPIL = ((COLOR_PUPIL >> 8) & 0xFF) / 255f;
    private static final float COLOR_B_PUPIL = (COLOR_PUPIL & 0xFF) / 255f;
    private static final float COLOR_R_MOUTH = ((COLOR_MOUTH >> 16) & 0xFF) / 255f;
    private static final float COLOR_G_MOUTH = ((COLOR_MOUTH >> 8) & 0xFF) / 255f;
    private static final float COLOR_B_MOUTH = (COLOR_MOUTH & 0xFF) / 255f;
    private static final float COLOR_R_EYEBROW = ((COLOR_EYEBROW >> 16) & 0xFF) / 255f;
    private static final float COLOR_G_EYEBROW = ((COLOR_EYEBROW >> 8) & 0xFF) / 255f;
    private static final float COLOR_B_EYEBROW = (COLOR_EYEBROW & 0xFF) / 255f;
    ...
    public static void renderGmodModel(LivingEntity entity, PoseStack poseStack, MultiBufferSource bufferSource,
        ...
        renderLimb(poseStack, solidConsumer, packedLight, LIMB_LENGTH, COLOR_R_SKIN, COLOR_G_SKIN, COLOR_B_SKIN);
        poseStack.popPose();
        ...
        renderLimb(poseStack, solidConsumer, packedLight, LIMB_LENGTH, COLOR_R_PANTS, COLOR_G_PANTS, COLOR_B_PANTS);
    ...
    private static void renderBody(PoseStack poseStack, VertexConsumer consumer, int packedLight) {
        ...
        addBox(matrix, consumer, -hw, -hh, -hd, hw, hh, hd, COLOR_R_SHIRT, COLOR_G_SHIRT, COLOR_B_SHIRT, 1f, packedLight);
    }
    ...
    private static void renderHead(PoseStack poseStack, VertexConsumer consumer, int packedLight) {
        ...
        addBox(matrix, consumer, -hs, -hs, -hs, hs, hs, hs, COLOR_R_SKIN, COLOR_G_SKIN, COLOR_B_SKIN, 1f, packedLight);
    ...
    private static void renderEyes(Matrix4f matrix, VertexConsumer consumer, int packedLight) {
        ...
        addFrontQuad(matrix, consumer,
                ...
                COLOR_R_EYE_WHITE, COLOR_G_EYE_WHITE, COLOR_B_EYE_WHITE, 1f, packedLight);
        ...
        addFrontQuad(matrix, consumer,
                ...
                COLOR_R_PUPIL, COLOR_G_PUPIL, COLOR_B_PUPIL, 1f, packedLight);
        ...
        addFrontQuad(matrix, consumer,
                ...
                COLOR_R_EYEBROW, COLOR_G_EYEBROW, COLOR_B_EYEBROW, 1f, packedLight);
    ...
    private static void renderMouth(Matrix4f matrix, VertexConsumer consumer, int packedLight) {
        ...
        addFrontQuad(matrix, consumer,
                ...
                COLOR_R_MOUTH, COLOR_G_MOUTH, COLOR_B_MOUTH, 1f, packedLight);
    }
    ...
    private static void renderShoe(PoseStack poseStack, VertexConsumer consumer, int packedLight) {
        ...
        addBox(matrix, consumer, -hw, -LIMB_LENGTH / 2 - hh, -hd, hw, -LIMB_LENGTH / 2 + hh, hd, COLOR_R_SHOES, COLOR_G_SHOES, COLOR_B_SHOES, 1f, packedLight);
    }
    ...
    private static void addQuad(Matrix4f matrix, VertexConsumer consumer,
        ...
        if (len > 0.0001f) { nx /= len; ny /= len; nz /= len; } else { nx = 0; ny = 1; nz = 0; }
