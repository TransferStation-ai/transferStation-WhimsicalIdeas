...
@Mod(Ransferstation_whimsicalideas.MODID)
public class Ransferstation_whimsicalideas {

    public static final String MODID = "transferstation_whimsicalideas";
    private static final Logger LOGGER = LogUtils.getLogger();

    public Ransferstation_whimsicalideas() {
    ...
    public static class ClientModEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            ...
            java.nio.file.Path configDir = net.minecraftforge.fml.loading.FMLPaths.CONFIGDIR.get()
                    .resolve(Ransferstation_whimsicalideas.MODID);
